...
<div className="border border-amber-700"></div>
  ...
  <div className="w-[90%] mx-auto mt-10  my-5 gap-5 ">

    <div className="w-full lg:w-[70%] rounded-2xl overflow-hidden mx-auto">
    <video
   ...
   <div className="w-full lg:w-[90%] mx-auto text-xl mt-10">
