...
const translations: Record<string, { en: string; ar: string }> = {
 ...
 "military.description": {
  en: "At Sama Holding, we deliver end-to-end solutions for defense facilities and mission-critical infrastructure—from planning and design to construction, commissioning, and operations—under strict safety and confidentiality. Our scope covers bases, training facilities, logistics depots, and C2 centers, alongside physical security, surveillance and access control, utilities (power, water, fuel), and redundant systems to ensure readiness and continuity. Multidisciplinary teams (civil/architectural/MEP/low-current & networks) integrate systems to deliver scalable, highly reliable outcomes. We focus on: Compliance with national/international standards and robust risk management. 24/7 readiness through redundancy, backup, and operational resilience. Information and systems security with controlled access and continuous monitoring. Quality, safety, and on-time delivery by vetted teams for high-sensitivity sites.",
  
   ar:" في سما القابضة نقدّم حلولًا متكاملة للمنشآت والمنظومات العسكرية من التخطيط والتصميم إلى التنفيذ والتشغيل، ضمن حوكمة صارمة للسلامة والسرية. يشمل نطاق عملنا تطوير القواعد ومرافق التدريب والمستودعات والخدمات اللوجستية ومراكز القيادة والسيطرة، إلى جانب أنظمة الأمن المادي والمراقبة والتحكّم في الدخول، والبنى التحتية للطاقة والمياه والوقود، وأنظمة احتياطية تضمن الجاهزية والاستمرارية. نعمل بفرق متعددة التخصصات (مدني/معماري/كهرباء وميكانيكا/أنظمة منخفضة الجهد وشبكات) لدمج الأنظمة وتسليم مشاريع عالية الاعتمادية وقابلة للتوسّع. نركّز على: الامتثال للمعايير الوطنية والدولية وإدارة المخاطر. جاهزية 24/7 عبر التكرار والنسخ الاحتياطي والمرونة التشغيلية. أمن المعلومات والأنظمة مع ضوابط وصول ومراقبة مستمرة. الجودة والسلامة والتسليم في المواعيد بفِرق مؤهّلة للمواقع الحسّاسة."},
...
"medical.description": {
  ...
  "civil.descriptionn": { en: "Sama offers a complete range of construction services...", ar: "تقدم سما مجموعة متكاملة من خدمات البناء والتشييد..."},

  "civil.electromechanical": { en: "Sama offers a wide range of electrical, mechanical, and plumbing services.", ar: "تقدم سما مجموعة واسعة من خدمات الكهرباء والميكانيكا والسباكة."},

  "civil.energyTransmission": {en: "Sama provides energy transmission services...", ar: "تقدم سما خدمات نقل الطاقة..."},
